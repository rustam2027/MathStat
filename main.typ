...
#question(6)[
  ...
  #theorem([])[
    Пусть $x_1 in (frak(X), frak(B))$, и $frak(A) subset frak(B)$ - класс измеримых подмножеств. Будем говорить, что для класса $frak(A)$ выполняется теорема Гливенко – Кантелли, если $sup A in frak(A)$
    $|P∗n(A) − Px1 (A)| -> п.н. 0 при n → ∞$
  ]
]
#question(7)[]
#question(8)[]
