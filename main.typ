...
#question(6)[
  ...
  #theorem([Гливенко-Кантели])[
    ...
    $ sup_(A in cal(A)) |P^∗_n (A) − cal(P)_x_1 (A)| display(->)_"п.н." 0 "при n" -> oo $
  ]
...
#question(7)[
  ...
  #definition([Состоятельность оценки])[
    Оценка $θ^∗_n$ называется состоятельной, если $ θ^∗_n display(->)_p theta "при" n -> oo $
  ]

  #definition([Сильная состоятельность оценки])[
    Оценка $θ^∗_n$ называется сильно состоятельной, если $ θ^∗_n display(->)_"п.н." theta "при" n -> oo $
  ]
